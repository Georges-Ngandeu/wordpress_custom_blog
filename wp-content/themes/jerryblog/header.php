    ...
    <header class="header  container">
      <div class="row  header__logo">
        ...
        <div class="col-md-6  logo">
          <h1><a class="logo__link" href="<?php echo site_url(''); ?>">Jerry.</a></h1>
          <div class="logo__description">Personal Blog</div>
        </div>
      ...
      <nav class="nav">
        <ul class="nav__list">
          <li class="nav__item <?php if(is_page('Home')) echo 'nav__item--active'; ?>">
            <a href="<?php echo site_url(''); ?>">Home</a>
          </li>
          <li class="nav__item <?php if(is_page('Blog')) echo 'nav__item--active'; ?>">
            <a href="<?php echo site_url('/blog/'); ?>">Blog</a>
          </li>
          <li class="nav__item <?php if(is_page('About')) echo 'nav__item--active'; ?>">
